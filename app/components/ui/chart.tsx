...
function ChartTooltipContent({
  ...
  labelFormatter?: (value: React.ReactNode, payload?: ChartTooltipItem[]) =>
    | React.ReactNode
    | null;
  formatter?: (
    value: number | string,
  ...
  return (
    <div
      className={cn(
        "border-border bg-popover text-popover-foreground grid min-w-[8rem] items-start gap-1.5 rounded-md border px-2.5 py-1.5 text-xs shadow-xl dark:shadow-none",
        className,
      )}
    >
